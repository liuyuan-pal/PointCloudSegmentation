...
def test_block():
    ...
    nidxs1, nlens1, nbegs1, ncens1 = search_neighborhood(pts2, 0.6)
    nidxs2, nlens2, nbegs2, ncens2 = search_neighborhood(pts2, 0.3)
    nidxs3, nlens3, nbegs3, ncens3 = search_neighborhood_range(pts2, 0.3, 0.45)
