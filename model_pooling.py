...
def test_semantic3d_block():
    ...
    from io_util import read_pkl,get_semantic3d_block_train_test_split
    import numpy as np
    import random
    ...
    for k in xrange(len(train_list)):
        ...
        # xyzs,rgbs,covars,labels=read_pkl('cur_data.pkl')
        ...
        [pts1, pts2, pts3], [dpts1, dpts2], feats, _, [vlens1, vlens2], [vbegs1, vbegs2], [vcens1, vcens2], vidx1, vidx2 = \
            points_pooling_two_layers_tmp(xyzs_pl, feats_pl, labels_pl, 0.6, 1.8, 20.0)

        nidxs1, nlens1, nbegs1, ncens1 = search_neighborhood(pts1, 0.4)
        nidxs2, nlens2, nbegs2, ncens2 = search_neighborhood(pts2, 1.2)
        nidxs3, nlens3, nbegs3, ncens3 = search_neighborhood(pts3, 3.6)
        ...
        for t in xrange(len(xyzs)):
            ...
            # check_vidxs(nl1,nb1,nc1)
            # check_vidxs(nl2,nb2,nc2)
            # check_vidxs(nl3,nb3,nc3)
            # check_nn(len(xyzs1),nn1,nl1,nb1,nc1)
            # check_nn(len(xyzs2),nn2,nl2,nb2,nc2)
            # check_nn(len(xyzs3),nn3,nl3,nb3,nc3)
